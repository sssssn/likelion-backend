...
public class RecursiveDFS {
    public void solution() throws IOException {
        ...
        // StringTokenizer: 입력 받은 문자열을 ' ' (또는 지정된 delimiter) 를 기준으로 나누어서 한 단어씩 변환해주는 도구
        ...
        // 인접 행렬: 2차원 배열
        // 만약 노드가 1부터 N + 1 까지라면 계산할 때 매번 -1을 해주거나 인접 행렬을 한칸 더 늘리거나
        int[][] adjMatrix = new int[maxNodes][maxNodes]; // 0부터 7까지 표현 가능한 인접 행렬
