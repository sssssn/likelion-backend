...
public class HeaderController {
    ...
    // 헤더 중 'x-likelion-int' 가 있으면 Integer 에 할당
    ...
    // 'header-all' 로 들어온 HTTP 요청에 대하여
    // 모든 헤더를 확인하고 싶을 때
    @PostMapping("/header-all")
    public String getHeaderAll(
//            @RequestHeader // 모든 헤더를 가져올 때 (1)
//            Map<String, String> headerMap

//            @RequestHeader // 모든 헤더를 가져올 때 (2)
//            MultiValueMap<String, String> headerMap

            @RequestHeader // 모든 헤더를 가져올 때 (3)
