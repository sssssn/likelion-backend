...
//            } else {
//                winningNumStrs.add(String.format("%d - ", winningNum.get(i)));
//            }
//        }
...
//        model.addAttribute("winningNumStrs", winningNumStrs);
    ...
    public String student(Model model) {
        ...
        model.addAttribute(
                "object",
                new Student("SN Kwon", "sn@gmail.com")
        );
        return "student";
    }
...
//        for (String item : listOfStrings);
        ...
        List<Student> studentList = Arrays.asList(
                new Student("sn", "sn@gmail.com"),
                new Student("tofu", "tofu@gmail.com"),
                new Student("pang", "pang@gmail.com")
        );
