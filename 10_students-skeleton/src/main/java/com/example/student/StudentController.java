...
//        throw new ResponseStatusException(HttpStatus.NOT_IMPLEMENTED);
    ...
    // id에 해당하는 StudentEntity 의 read.html 응답
    @GetMapping("/{id}")
    public String read(
...
//        throw new ResponseStatusException(HttpStatus.NOT_IMPLEMENTED);
    ...
    // id에 해당하는 StudentEntity 의 update.html 응답
...
//        throw new ResponseStatusException(HttpStatus.NOT_IMPLEMENTED);
    ...
    @PostMapping("/{id}/update") // create 와 유사
...
//        throw new ResponseStatusException(HttpStatus.NOT_IMPLEMENTED);
    ...
    @GetMapping("/{id}/delete-view") // update-view 와 유사
