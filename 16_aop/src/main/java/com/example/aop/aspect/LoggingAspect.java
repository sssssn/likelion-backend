...
@Slf4j // log 추가
@Aspect // 해당 클래스가 관점(Aspect) 임을 드러내는 어노테이션
...
//    @Before("within(com.example.aop.controller..*)")
    ...
    // JoinPoint: 해당 Advice 가 실행된 JoinPoint (addUser)
